document.addEventListener('DOMContentLoaded', function() {
    ...
    async function fetchZoneDetails() {
        try {
            ...
            const response = await fetch(`https://bni-data-backend.onrender.com/api/getZone/${zoneId}`);
    ...
    form.addEventListener('submit', async function(e) {
        ...
        if (result.isConfirmed) {
            try {
                ...
                const response = await fetch(`https://bni-data-backend.onrender.com/api/updateZone/${zoneId}`, {
                    method: 'PUT',
                    body: formData
                });
