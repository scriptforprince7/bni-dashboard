document.addEventListener('DOMContentLoaded', async function() {
    ...
    try {
        ...
        const requisitionsResponse = await fetch('http://localhost:5000/api/getRequestedChapterRequisition');
    ...
    try {
        ...
        if (pickupDate) {
            try {
                ...
                const getRequisitionResponse = await fetch('http://localhost:5000/api/getRequestedChapterRequisition');
...
async function markAsGiven(requisitionId, combinationKey) {
    try {
        ...
        const chapterReqResponse = await fetch('http://localhost:5000/api/getRequestedChapterRequisition');
        ...
        if (currentRequisition.visitor_id) {
            ...
            const memberReqResponse = await fetch('http://localhost:5000/api/getRequestedMemberRequisition');
            ...
            if (matchingRequisition) {
                ...
                const memberUpdateResponse = await fetch('http://localhost:5000/api/updateMemberRequisition', {
                    method: 'PUT',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
                        member_id: memberId,
