    ...
    if (chaptersCount > 0 || membersCount > 0) {
        ...
        if (result.isConfirmed) {
            ...
            try {
                ...
                const getResponse = await fetch(`https://bni-data-backend.onrender.com/api/getRegion/${region_id}`);
                ...
                const updateResponse = await fetch(`https://bni-data-backend.onrender.com/api/updateRegion/${region_id}`, {
                    method: 'PUT',
                    headers: {
