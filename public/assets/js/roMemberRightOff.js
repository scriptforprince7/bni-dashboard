...
const memberApiUrl = 'http://backend.bninewdelhi.com/api/members';
const getBankOrderApi = 'http://backend.bninewdelhi.com/api/getBankOrder';
let creditType;
let chapterEmail;
let current_User;
...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        // Fetch regions
        console.log('Fetching regions from:', 'http://backend.bninewdelhi.com/api/regions');
        const regionsResponse = await fetch('http://backend.bninewdelhi.com/api/regions');
            ...
            try {
                ...
                document.querySelector('.add_bill').addEventListener('click', async () => {
                    try {
                        ...
                        showLoader();
                        const response = await fetch('http://backend.bninewdelhi.com/api/addMemberWriteOff', {
                            method: 'POST',
                            headers: {
