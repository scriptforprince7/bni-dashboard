...
(async function() {
    ...
    try {
        ...
        const regions = await fetch('http://backend.bninewdelhi.com/api/regions').then(res => res.json());
        ...
        const chapters = await fetch('http://backend.bninewdelhi.com/api/chapters').then(res => res.json());
        ...
        members = await fetch('http://backend.bninewdelhi.com/api/members').then(res => res.json());
    ...
    async function autofillFields() {
        if (selectedRegion && selectedChapter) {
            try {
                ...
                const chapter = await fetch(`http://backend.bninewdelhi.com/api/getChapter/${selectedChapter}`)
                    .then(res => res.json());
                ...
                const hotelResponse = await fetch(`http://backend.bninewdelhi.com/api/getHotels`);
    ...
    document.querySelector('.add_bill').addEventListener('click', async (e) => {
        ...
        try {
            ...
            const response = await fetch('http://backend.bninewdelhi.com/api/addKittyPayment', {
                method: 'POST',
                headers: {
