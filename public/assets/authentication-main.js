(function () {
    ...
    if (localStorage.xintrartl) {
        ...
        document.querySelector("#style")?.setAttribute("href", "http://127.0.0.1:5500/ assets/libs/bootstrap/css/bootstrap.rtl.min.css");
            // rtlFn();
    }
...
function ltrFn() {
    ...
    if(!document.querySelector("#style").href.includes('bootstrap.min.css')){
        document.querySelector("#style")?.setAttribute("href", "http://127.0.0.1:5500/ assets/libs/bootstrap/css/bootstrap.min.css");
    }
